---
description: >-
  Connect your BigQuery project to Quper to track query costs and slot
  consumption.
icon: database
---
...
* Quper supports connecting **multiple GCP projects** — repeat this process for each project, or connect at the billing account level via the [GCP integration](../cloud-providers/gcp.md) to cover all projects automatically
